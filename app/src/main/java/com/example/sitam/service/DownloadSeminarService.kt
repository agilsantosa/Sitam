...
import com.example.sitam.ui.seminar.dosen.DetailBimbinganSeminarViewDosenFragment


class DownloadSeminarService : IntentService("DownloadSeminarService") {

    companion object {
        val TAG = DownloadSeminarService::class.java.simpleName
    }
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (intent != null) {
            ...
            val notifyFinishIntent = Intent(DetailBimbinganSeminarViewDosenFragment.ACTION_DOWNLOAD_STATUS)
