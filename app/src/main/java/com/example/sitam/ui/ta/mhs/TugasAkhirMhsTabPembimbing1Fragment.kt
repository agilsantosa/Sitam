...
import com.example.sitam.databinding.FragmentTugasAkhirMhsTabPembimbing1Binding
import com.example.sitam.ui.seminar.mhs.DetailBimbinganSeminarMhsActivity
...
import com.example.sitam.ui.ta.mhs.viewmodel.TugasAkhirTabPembimbing1ViewModel
import com.example.sitam.utils.Constants
import com.example.sitam.utils.Resource
import com.example.sitam.utils.SharedPreferenceProvider

class TugasAkhirMhsTabPembimbing1Fragment : Fragment() {

    private var _binding: FragmentTugasAkhirMhsTabPembimbing1Binding? = null
    private val binding get() = _binding!!
    private val tugasAkhirTabPembimbing1ViewModel: TugasAkhirTabPembimbing1ViewModel by activityViewModels()
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater,R.layout.fragment_tugas_akhir_mhs_tab_pembimbing1, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tugasAkhirTabPembimbing1ViewModel.getListbBimbinganSeminar(token, idTa, "Pembimbing 1")
    ...
    private fun setupRecylerView() {
        ...
        binding.rvTugasAkhirPembimbing1Mhs.apply {
    ...
    private fun hideProgressBar() {
        binding.rvTugasAkhirPembimbing1Mhs.visibility = View.VISIBLE
    ...
    private fun showProgressBar() {
        binding.rvTugasAkhirPembimbing1Mhs.visibility = View.GONE
