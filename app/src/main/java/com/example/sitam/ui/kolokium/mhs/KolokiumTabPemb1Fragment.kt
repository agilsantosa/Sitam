...
import com.example.sitam.databinding.FragmentKolokiumTabPemb1Binding
...
import com.example.sitam.ui.kolokium.mhs.viewmodel.KolokiumTabPemb1ViewModel
import com.example.sitam.utils.Constants
import com.example.sitam.utils.Resource
import com.example.sitam.utils.SharedPreferenceProvider

class KolokiumTabPemb1Fragment : Fragment() {

    private var _binding: FragmentKolokiumTabPemb1Binding? = null
    ...
    private val kolokiumTabPemb1ViewModel: KolokiumTabPemb1ViewModel by activityViewModels()
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater, R.layout.fragment_kolokium_tab_pemb1, container, false)
        ...
        kolokiumTabPemb1ViewModel.getListbBimbinganKolokium(token, idKolokium, "Pembimbing 1")
        kolokiumTabPemb1ViewModel.requestListBimbinganKolokium.observe(viewLifecycleOwner, { response ->
            when (response) {
                is Resource.Succes -> {
                    hideProgressBar()
                    response.data?.let {
    ...
    private fun setupRecylerView() {
        ...
        binding.rvKolokiumPembimbing1Mhs.apply {
    ...
    private fun hideProgressBar() {
        binding.rvKolokiumPembimbing1Mhs.visibility = View.VISIBLE
    ...
    private fun showProgressBar() {
        binding.rvKolokiumPembimbing1Mhs.visibility = View.GONE
