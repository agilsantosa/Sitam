...
class TugasAkhirTabPembimbing2ViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val _requestListBimbinganTa: MutableLiveData<Resource<ResponseListBimbinganTaMhs>> =
        MutableLiveData()
